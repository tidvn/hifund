    ...
    <ScrollArea className="h-full">
      <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
        ...
        <div className="mt-10 flex justify-between flex-wrap">
          <CampaignCard className="mb-6" campain={campaignCard[0]} url="/dashboard/campaign/mycampaign/1"/>
          <CampaignCard className="mb-6" campain={campaignCard[1]} url="/dashboard/campaign/mycampaign/1"/>
          <CampaignCard className="mb-6" campain={campaignCard[2]} url="/dashboard/campaign/mycampaign/1"/>
          <CampaignCard className="mb-6" campain={campaignCard[3]} url="/dashboard/campaign/mycampaign/1"/>
          <CampaignCard className="mb-6" campain={campaignCard[4]} url="/dashboard/campaign/mycampaign/1"/>
          <CampaignCard className="mb-6" campain={campaignCard[5]} url="/dashboard/campaign/mycampaign/1"/>
        </div>
      </div>
    </ScrollArea>
  );
