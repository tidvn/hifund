  ...
  return (
    <div className='p-8'>
      ...
      <Table className='mt-10 border-collapse  border border-slate-400 rounded-lg bg-white '>
        <TableBody>
          <TableRow>
            <TableHead className="text-black font-semibold border border-slate-400">Milestone submitted at</TableHead >
            <TableCell className='border border-slate-400'>February 21, 2024 at 6:15 AM</TableCell>
          ...
          <TableRow>
            ...
            <TableCell className='border border-slate-400'>Chung Ta Cua Tuong Lai</TableCell>
            <TableCell className='border border-slate-400'></TableCell>
          </TableRow>
          <TableRow>
          ...
          <TableRow>
            ...
            <TableCell className='border border-slate-400'>
              <ul className="my-3 ml-6 list-disc [&>li]:mt-2">
                <li>Debugger allows for the execution of UPLC code step-by-step</li>
                <li>Capability to display terms in scope and call stack on command</li>
          ...
          <TableRow>
            <TableHead className="text-black font-semibold border border-slate-400">Project Completion</TableHead >
            <TableCell className='border border-slate-400'>
