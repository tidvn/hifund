      ...
      <CardContent>
        <form>
          <div className="grid w-full items-center gap-4">
            {isSupported&&<div className="flex justify-between">
            ...
            <div className="flex flex-col space-y-1.5">
              ...
              <Label className="font-bold text-xl">{milestoneRecap.startedAt}</Label>
            </div>
            <div className="bg-[#eceffe] p-4 font-semibold">
              ...
              <ul className="my-3 ml-6 list-disc [&>li]:mt-2">
                {milestoneRecap.schedule?.map((x, i) =>
